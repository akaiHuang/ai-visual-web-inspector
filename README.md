...
AI Visual Web Inspector is a Playwright MCP-based toolkit that lets AI agents inspect rendered web pages with visual and DOM context. It is built for UI/UX audits, regression support, frontend debugging, and feature decomposition.
